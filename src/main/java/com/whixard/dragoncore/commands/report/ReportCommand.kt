package com.whixard.dragoncore.commands.report

import com.whixard.dragoncore.api.ReportAPI
                ...
                if (args.size == 1) {
                    if (args[0].equals("list", true)) {
                        ...
                        for (report in ReportAPI().getReports()) {
                            ...
                            deletebutton.clickEvent = net.md_5.bungee.api.chat.ClickEvent(
                            ...
                            checkbutton.clickEvent = net.md_5.bungee.api.chat.ClickEvent(
                                net.md_5.bungee.api.chat.ClickEvent.Action.RUN_COMMAND,
                                "/report check ${report.id}"
                            )
